	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'',       // Ex. related-post-inside-plugin-settings /  edit.php?post_type=page .
				__( 'Recommended', 'related-post-inside-plugin' ),
				__( 'Recommended', 'related-post-inside-plugin' ),
				'manage_options',
				'related-post-inside-plugin-recommended-plugins',
